    ...
    val listData: ArrayList<UserData>
        get() {
            ...
            for (position in username.indices) {
                ...
                userdata.name = name[position]
                userdata.username = username[position]
                userdata.avatar = avatar[position]
                userdata.company = company[position]
                userdata.location = location[position]
                userdata.repository = repository[position]
                userdata.follower = follower[position]
                userdata.following = following[position]
                list.add(userdata)
            }
            return list
        }
